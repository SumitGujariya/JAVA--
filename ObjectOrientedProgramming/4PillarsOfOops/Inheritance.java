...
// We inherit the properties if the base class with the help of (Extends keyword).
...
// In some branch we see single inheritance and somewhere we see multi level inhertance.



// This is multiple inheritance 
// We never see multiple inhertance in class form but we write with the help of (Interfaces).